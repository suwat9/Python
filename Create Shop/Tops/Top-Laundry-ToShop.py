...
fileOrg ="D:/Codes/Mali-Python/Create Shop/Tops/Split-Eng - Tops-Fabric Softener - JAN2022 - 144SKU.xlsx" 
wbOrg = xl.load_workbook(fileOrg)
wsOrg = wbOrg.worksheets[0]

fileTemplate ="D:/Codes/Mali-Python/Create Shop/shop14/Upload-Malishop14-TopEng-Softener144.xlsx"
...
for i in range(0, maxOrg_row+1):
    ...
    order = str(i + 1)
    shopName = 'Malishop14-Top-Laundry'+order.zfill(4)
