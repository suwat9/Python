...
fileOrg ="D:/Codes/Mali-Python/Create Shop/Tops/Split-Eng - Tops-Dog Food - JAN2022 - 100SKU.xlsx" 
wbOrg = xl.load_workbook(fileOrg)
wsOrg = wbOrg.worksheets[0]

fileTemplate ="D:/Codes/Mali-Python/Create Shop/shop14/Upload-Malishop14-TopEng-DogFood120.xlsx"
...
for i in range(0, maxOrg_row+1):
    ...
    order = str(i + 1)
    shopName = 'Malishop14-Top-DogFood'+order.zfill(4)
