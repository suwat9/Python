...
fileOrg ="D:/Codes/Mali-Python/Create Shop/Tops/Split-Eng - Tops-Powder Detergent - JAN2022 - 67SKU.xlsx"
wbOrg = xl.load_workbook(fileOrg)
wsOrg = wbOrg.worksheets[0]

fileTemplate ="D:/Codes/Mali-Python/Create Shop/shop14/Upload-Malishop14-TopEng-PowderDetergent.xlsx"
...
col_list = [['ProductName2','*ชื่อสินค้า'],['Pic1-src','*รูปของสินค้า1'],
            ...
            ['ProductName2','Long Description (Lorikeet)']
            ]
...
for i in range(0, maxOrg_row+1):
    ...
    order = str(i + 1)
    shopName = 'Malishop14-Top-PowderDetergent'+order.zfill(4)
    ...
    wsTemp.cell(row=write_start_row+i, column=colTemp.index('Long Description (Lorikeet)')+1,value=detail.value)
