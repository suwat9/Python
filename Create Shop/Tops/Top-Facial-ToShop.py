...
fileOrg ="D:/Codes/Mali-Python/Create Shop/Tops/Split-Eng - Tops-Facial Care - JAN2022 - 499SKU.xlsx"
wbOrg = xl.load_workbook(fileOrg)
wsOrg = wbOrg.worksheets[0]

fileTemplate ="D:/Codes/Mali-Python/Create Shop/shop14/Upload-Malishop14-TopEng-Facial.xlsx"
...
for i in range(0, maxOrg_row+1):
    ...
    order = str(i + 1)
    shopName = 'Malishop14-Top-Facial'+order.zfill(4)
